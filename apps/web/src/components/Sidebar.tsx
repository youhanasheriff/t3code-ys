...
// Brand wordmark is rendered as two-tone text derived from the app name
// (e.g. "YS" bold + "Code" muted), so it follows the configured branding.
const BRAND_NAME_PARTS = APP_BASE_NAME.split(" ");
const BRAND_NAME_HEAD = BRAND_NAME_PARTS[0] ?? APP_BASE_NAME;
const BRAND_NAME_TAIL = BRAND_NAME_PARTS.slice(1).join(" ");
